...
class PCA:
    ...
    def fit_transform(self, X):
        ...
        # STEP 3 Eigendecomposition: COMPUTE THE EIGENVECTORS AND EIGENVALUES OF THE COVARIANCE MATRIX TO IDENTIFY THE
        ...
        # FINALLY: RECAST THE DATA ALONG THE PRINCIPAL COMPONENTS AXES
